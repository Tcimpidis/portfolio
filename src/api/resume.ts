...
export const ResumeData:ResumeDataDto = {
  ...
  },
  {
    ...
    "Work directly with business shareholders."], 
  },
  {
    entity: "C.H.Robinson Worldwide",
    location: "Eden Prairie, MN",
    ...
    responsibilities: ["Work across various teams and technologies to ensure business needs are met and delivered.",
    ...
    "transitioned from a role in a delivery team working in an older tech stack to a greenfield project that was working with newer tech."], 
  },
  {
    entity: "C.H.Robinson Worldwide",
    location: "Eden Prairie, MN",
    ...
    responsibilities: ["Built code enhancements.",
